...
You can install the development version of odbr from [CRAN](https://cran.r-project.org/web/packages/odbr/index.html) with:
...
The logo was designed by [Marcos Kyoto de Tani e Isoda](https://instagram.com/redes.urbanas?igshid=MzRlODBiNWFlZA==)
